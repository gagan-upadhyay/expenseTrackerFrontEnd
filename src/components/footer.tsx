...
export default function Footer() {
  ...
  return (
    <footer className={`${theme==='light'?'bg-gray-100 shadow-[0_-1px_6px_-2px_rgba(18,18,20,1)]':'bg-neutral-900 shadow-[0_-1px_6px_-1px_rgba(229,231,235,1)]'} opacity-80 w-full absolute bottom-0 py-4 `}>
