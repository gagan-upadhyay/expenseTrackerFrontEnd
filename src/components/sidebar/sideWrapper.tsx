...
export default function SidebarWrapper(){
    ...
    const {user} = useUser();
    console.log('Value of user from sideWrapper:\n', user);
    ...
    const baseClass = "flex grow h-full space-x-2 flex-col sm:space-x-0 sm:space-y-1 py-5 transition-all duration-500 ease-in-out border-r-0 rounded-2xl h-fit";
    ...
    return(
        <>
            <div className={clsx(classes, "sm:block hidden")}>
            ...
            <div className={clsx(classes, "sm:hidden block")}>
                <div className="flex">
