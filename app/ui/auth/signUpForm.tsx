...
export default function RegisterForm(){
    ...
    return(
        <form onSubmit={handleRegister} className="w-screen px-6 pb-4 pt-8 bg-gray-50/70 md:bg-gray-50 rounded-lg mb-30 max-w-xs md:max-w-sm">
            ...
            <div className="flex flex-col">
                <div className="mb-4">
                    ...
                    <UsersIcon className="pointer-events-none text-gray-500 absolute top-33 ml-2 h-[18px] w-[18px] "/>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <UsersIcon className="pointer-events-none text-gray-500 absolute top-53 ml-2 h-[18px] w-[18px] "/>
                </div>
                <div className='mb-4'>
                    ...
                    <AtSymbolIcon className="pointer-events-none text-gray-500 absolute top-72 ml-2 h-[18px] w-[18px]"/>
                </div>
                <div className='mb-14'>
                    ...
                    <KeyIcon className=" pointer-events-none mr-3 h-[18px] w-[18px] absolute top-92 text-gray-500 ml-3"/>
                </div>
                <Button className="absolute top-100 mt-2 left-70" href="">Register</Button>
                <ToastContainer/>
                <div>
                    <p className="text-gray-500 text-xs absolute top-103">Already Registered? <Link className="text-blue-400" href={'/auth/login'}>Login here</Link></p>
                </div>
            </div>
        </form>
    )
